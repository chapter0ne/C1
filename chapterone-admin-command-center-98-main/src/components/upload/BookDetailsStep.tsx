        ...
        <CardContent className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              >
                {showSocials ? 'Hide' : 'Add Social Media'}
                <svg className={`w-4 h-4 transition-transform duration-200 ${showSocials ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
